...
const getUserChannelProfile = asyncHandler(async (req,res) => {
    // we will not this data from our body but from parameter passed in url coz generally we go by routes
    ...
    const channel = await User.aggregate([
        ...
        {
            $lookup : {
                // name of table stored in db model mei Subscription hai lekin jab vo db mei save hota hai toh pplural and lowercase mei ho jata hai 
                from : "subscriptions",
                localField : "_id",
        ...
        },
        {
            $addFields : {
                subscribersCount : {
                    // this will count from subscriber field we added above
                    $size : "subscribers"
                },
                channelsSubscribedToCount : {
                    // this will count how many one channels one has subscribed
                    $size : "subscribedTo"
                },
                isSubscribed : {
                    $cond : {
